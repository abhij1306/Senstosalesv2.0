...
def bad_request(message: str, log_details: Optional[str] = None) -> HTTPException:
    """
...
def not_found(message: str, resource_type: Optional[str] = None) -> HTTPException:
    """
...
def conflict(message: str, log_details: Optional[str] = None) -> HTTPException:
    """
...
def forbidden(message: str, reason: Optional[str] = None) -> HTTPException:
    """
