...
def get_financial_year(date_obj) -> str:
    """
    Calculate Financial Year from date object/string
    FY starts April 1st
    Example: 2024-03-31 -> '2023-24', 2024-04-01 -> '2024-25'
    """
    ...
    if month < 4:
        # Jan-Mar is part of previous year
        return f"{year - 1}-{str(year)[2:]}"
    else:
        # Apr-Dec is start of this year
