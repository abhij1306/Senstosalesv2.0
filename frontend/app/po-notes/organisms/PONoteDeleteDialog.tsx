...
import { Button, Body, Title3, Flex, Stack } from "@/components/design-system";
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from "@/components/design-system/molecules/Dialog";
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-md">
                <DialogHeader>
                    <DialogTitle>Termination Protocol</DialogTitle>
                </DialogHeader>
                ...
                <Stack gap={4} className="py-2">
                    <Flex align="center" gap={4} className="p-4 bg-app-status-error/5 border-none rounded-2xl elevation-1">
                        ...
                        <Stack gap={1}>
                            <Title3 className="text-sm text-app-status-error">Irreversible Action</Title3>
