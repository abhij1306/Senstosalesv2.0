                        ...
                        */}
                        <div className="flex h-screen bg-transparent overflow-hidden relative">
                            ...
                            <div className="flex-1 flex flex-col relative overflow-hidden bg-transparent">
                                {/* Tahoe Header */}
                                <header className="h-20 flex items-center justify-between px-8 py-4 z-10 header-glass">
                                    {/* Master Search Bar */}
                                ...
                                {/* Main Content Area */}
                                <main
                                    className="flex-1 overflow-y-auto px-8 pt-2 pb-10 scroll-smooth no-scrollbar"
                                >
